...
export function StreakWidget() {
  ...
  return (
    <div className="group relative rounded-3xl bg-gradient-to-br from-blue-400 via-blue-600 to-blue-500 p-6 shadow-xl shadow-orange-200/30 hover:shadow-2xl hover:shadow-orange-300/40 transition-all duration-500 transform hover:-translate-y-2 text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center">
          <div className={`text-6xl font-bold mb-2 ${isAnimating ? 'animate-pulse' : ''}`}>
            {streak}
          </div>
