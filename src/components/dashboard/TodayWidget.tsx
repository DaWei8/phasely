...
export function TodayWidget() {
  ...
  return (
    <div
      className="group relative rounded-3xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 shadow-xl shadow-blue-200/20 dark:shadow-blue-900/20 border border-white/20 dark:border-gray-700/20 hover:shadow-2xl hover:shadow-blue-300/30 dark:hover:shadow-blue-700/30 transition-all duration-500 transform hover:-translate-y-2"
